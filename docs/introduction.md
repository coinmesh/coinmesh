...
All of these initiatives have been paramount to the success of Litecoin and Bitcoin. They have become the financial infrastructure that will inevitably support the wave of coming applications.  If these three services represent the trunk of a tree, then the applications are its branches. With the advent of SegWit and a rapidly developing Layer 2, we are also at the cusp of becoming transactionally ready to process the high volume that will naturally be fostered through increased app development.
